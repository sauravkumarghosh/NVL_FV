...
begin
    ...
    if isundefined(guard_failed) then
    Guard((opcode=UPI_Opcode__RdCode | opcode=UPI_Opcode__RdData | opcode=UPI_Opcode__RdDataMig | opcode=UPI_Opcode__RdInvOwn | opcode=UPI_Opcode__InvXtoI | opcode=UPI_Opcode__InvItoE | opcode=UPI_Opcode__RdInv | opcode=UPI_Opcode__InvItoM | opcode=UPI_Opcode__RdCur | opcode=UPI_Opcode__WbMtoI | opcode=UPI_Opcode__WbMtoS | opcode=UPI_Opcode__WbMtoE | opcode=UPI_Opcode__WbEtoI ));
    if isundefined(guard_failed) then
