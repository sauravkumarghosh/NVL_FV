...
class Config(rbw.Globals):
    ...
    NUM_SOTUPIAgents = rbw.Const(default=2)
    ...
    MAX_UPIAgentID = rbw.Const(default=4)   ## summation of three params above    ## V: try lambda function
    ...
    MAX_AgentID = rbw.Const(default=4)  ## max of {MAX_UPIAgentID, MAX_IDICAgentID}
    Agents = rbw.Range(MAX_AgentID)
    # MAX_AgentIDp1 = rbw.Const(default=MAX_AgentID+1)
    # Agentsp1 = rbw.Range(MAX_AgentIDp1)

    Agent_count = rbw.Const(default=7)  ## summation of MAX_UPIAgentID, MAX_IDICAgentID
